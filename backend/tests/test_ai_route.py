...
class TestAiTestRoute:
    ...
    def test_returns_ai_result(self, mock_chat, auth_client):
    ...
    @patch("app.routes.ai_test.chat_completion")
    def test_uses_default_prompt(self, mock_chat, auth_client):
        client, token, username = auth_client
        mock_chat.return_value = "4"
    ...
    @patch("app.routes.ai_test.chat_completion")
    def test_returns_502_on_ai_failure(self, mock_chat, auth_client):
        client, token, username = auth_client
